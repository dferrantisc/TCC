...
function initModels(sequelize) {
    ...
    produtos.belongsTo(categoria_produto, {
        as: "categoria",
        foreignKey: "idcatg",
    });
    categoria_produto.hasMany(produtos, { as: "produtos", foreignKey: "idcatg" });
    produtos.belongsTo(proprietariofuncionario, {
        as: "idadm_proprietariofuncionario",
        foreignKey: "idadm",
    });
    proprietariofuncionario.hasMany(produtos, {
        as: "produtos",
        foreignKey: "idadm",
    });
    ...
    sorteio_cliente.belongsTo(sorteio, {
        as: "idsort_sorteio",
        foreignKey: "idsort",
    });
    sorteio.hasMany(sorteio_cliente, {
        as: "sorteio_clientes",
        foreignKey: "idsort",
    });
    ganhadores.belongsTo(usuariocliente, {
        as: "iduc_usuariocliente",
        foreignKey: "iduc",
    });
    usuariocliente.hasMany(ganhadores, { as: "ganhadores", foreignKey: "iduc" });
    sorteio_cliente.belongsTo(usuariocliente, {
        as: "iduc_usuariocliente",
        foreignKey: "iduc",
    });
    usuariocliente.hasMany(sorteio_cliente, {
        as: "sorteio_clientes",
        foreignKey: "iduc",
    });
